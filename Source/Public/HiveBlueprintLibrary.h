...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Integrations StripeIntegrationDetails"))
struct FHiveintegration_StripeIntegrationDetails
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString encryptedPublicKey;

  UPROPERTY(BlueprintReadOnly)
  FString encryptedSecretKey;

};

struct FHiveintegration_StripeIntegrationDetails DeserializeFHiveintegration_StripeIntegrationDetails(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Integrations StripeIntegrationStatus"))
struct FHiveintegration_StripeIntegrationStatus
{
	GENERATED_BODY()
...
struct FHiveintegration_StripeIntegrationStatus DeserializeFHiveintegration_StripeIntegrationStatus(TSharedPtr<FJsonObject> obj);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fintegration_Stripe_stripeGET_Delegate, const FHiveintegration_StripeIntegrationDetails, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Uintegration_Stripe_stripeGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Returns the Stripe public and secret keys that were configured for integration", ToolTip=""), Category="HiveMP|Integrations")
	static Uintegration_Stripe_stripeGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fintegration_Stripe_stripePUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Uintegration_Stripe_stripePUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripePUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripePUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Configures Stripe integration for this project", ToolTip="Calling this method sets up Stripe integration for the project. This enables accepting\npayments through Stripe for revenue share invoices."), Category="HiveMP|Integrations")
	static Uintegration_Stripe_stripePUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  FString Field_publicKey;

  FString Field_secretKey;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fintegration_Stripe_stripeDELETE_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Uintegration_Stripe_stripeDELETE : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeDELETE_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeDELETE_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Removes Stripe integration from this project", ToolTip="Deletes the public and secret Stripe keys stored in Hive, disabling all Stripe integration.\n\nPlease note that if you remove integration, it will immediately prevent any Stripe-enabled\nrevenue share payments from being completed online."), Category="HiveMP|Integrations")
	static Uintegration_Stripe_stripeDELETE* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fintegration_Stripe_stripeTogglePUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Uintegration_Stripe_stripeTogglePUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeTogglePUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeTogglePUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Enables or disables Stripe integration", ToolTip="Enables or disables Stripe integration without changing the public or secret keys.  When Stripe\nis first configured, it is enabled.  If Stripe is not configured at all, this API will return\nan error.\n\nPlease note that if you disable integration, it will immediately prevent any Stripe-enabled\nrevenue share payments from being completed online."), Category="HiveMP|Integrations")
	static Uintegration_Stripe_stripeTogglePUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fintegration_Stripe_stripeStatusGET_Delegate, const FHiveintegration_StripeIntegrationStatus, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Uintegration_Stripe_stripeStatusGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeStatusGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fintegration_Stripe_stripeStatusGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Returns the status of Stripe integration for administration viewing", ToolTip=""), Category="HiveMP|Integrations")
	static Uintegration_Stripe_stripeStatusGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale PointOfSaleEvent"))
struct FHivepos_PointOfSaleEvent
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale PaginatedPointOfSaleEvents"))
struct FHivepos_PaginatedPointOfSaleEvents
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  TArray<FHivepos_PointOfSaleEvent> results;

};

struct FHivepos_PaginatedPointOfSaleEvents DeserializeFHivepos_PaginatedPointOfSaleEvents(TSharedPtr<FJsonObject> obj);

struct FHivepos_PointOfSaleEvent DeserializeFHivepos_PointOfSaleEvent(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale PointOfSaleEventSearchResult"))
struct FHivepos_PointOfSaleEventSearchResult
{
	GENERATED_BODY()
...
struct FHivepos_PointOfSaleEventSearchResult DeserializeFHivepos_PointOfSaleEventSearchResult(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale LicenseKeyPool"))
struct FHivepos_LicenseKeyPool
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale PaginatedLicenseKeyPools"))
struct FHivepos_PaginatedLicenseKeyPools
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  TArray<FHivepos_LicenseKeyPool> results;

};

struct FHivepos_PaginatedLicenseKeyPools DeserializeFHivepos_PaginatedLicenseKeyPools(TSharedPtr<FJsonObject> obj);

struct FHivepos_LicenseKeyPool DeserializeFHivepos_LicenseKeyPool(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale LicenseKeyPoolSearchResult"))
struct FHivepos_LicenseKeyPoolSearchResult
{
	GENERATED_BODY()
...
struct FHivepos_LicenseKeyPoolSearchResult DeserializeFHivepos_LicenseKeyPoolSearchResult(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale PoolInsertResults"))
struct FHivepos_PoolInsertResults
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString /* JSON STRING */ results;

};

struct FHivepos_PoolInsertResults DeserializeFHivepos_PoolInsertResults(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale ReservedKey"))
struct FHivepos_ReservedKey
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString reservedAtEventId;

  UPROPERTY(BlueprintReadOnly)
  FString reservedForEmail;

  UPROPERTY(BlueprintReadOnly)
  int32 reservedOnDate;

};

struct FHivepos_ReservedKey DeserializeFHivepos_ReservedKey(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale IssuedKey"))
struct FHivepos_IssuedKey
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString issuedAtEventId;

  UPROPERTY(BlueprintReadOnly)
  FString issuedToEmail;
...
struct FHivepos_IssuedKey DeserializeFHivepos_IssuedKey(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale LicenseKey"))
struct FHivepos_LicenseKey
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString licensePoolId;

  UPROPERTY(BlueprintReadOnly)
  FString reservedEventId;

  UPROPERTY(BlueprintReadOnly)
  FString reservedForEmail;

  UPROPERTY(BlueprintReadOnly)
  int32 dateReservedUtc;

  UPROPERTY(BlueprintReadOnly)
  FString issuedEventId;
  ...
  UPROPERTY(BlueprintReadOnly)
  int32 dateActivatedUtc;

};

struct FHivepos_LicenseKey DeserializeFHivepos_LicenseKey(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Point of Sale ProductPointOfSale"))
struct FHivepos_ProductPointOfSale
{
	GENERATED_BODY()
...
struct FHivepos_ProductPointOfSale DeserializeFHivepos_ProductPointOfSale(TSharedPtr<FJsonObject> obj);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Event_eventsGET_Delegate, const FHivepos_PaginatedPointOfSaleEvents, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Event_eventsGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventsGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventsGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Event_eventsGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Event_eventsSearchGET_Delegate, const TArray<FHivepos_PointOfSaleEventSearchResult>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Event_eventsSearchGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventsSearchGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventsSearchGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Event_eventsSearchGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Event_eventGET_Delegate, const FHivepos_PointOfSaleEvent, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Event_eventGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Event_eventGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Event_eventPUT_Delegate, const FHivepos_PointOfSaleEvent, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Event_eventPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Event_eventPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  int32 Field_eventStartUtc;

  int32 Field_eventEndUtc;

  TArray<FString> Field_productIds;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Event_eventPOST_Delegate, const FHivepos_PointOfSaleEvent, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Event_eventPOST : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventPOST_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Event_eventPOST_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Event_eventPOST* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_poolsGET_Delegate, const FHivepos_PaginatedLicenseKeyPools, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_poolsGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolsGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolsGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_poolsGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_poolsSearchGET_Delegate, const TArray<FHivepos_LicenseKeyPoolSearchResult>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_poolsSearchGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolsSearchGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolsSearchGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_poolsSearchGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_poolGET_Delegate, const FHivepos_LicenseKeyPool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_poolGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_poolGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_poolPUT_Delegate, const FHivepos_LicenseKeyPool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_poolPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_poolPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_poolPOST_Delegate, const FHivepos_LicenseKeyPool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_poolPOST : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolPOST_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_poolPOST_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_poolPOST* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_keysPUT_Delegate, const FHivepos_PoolInsertResults, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_keysPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_keysPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  TArray<FString> Field_keys;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_keysReservePUT_Delegate, const FHivepos_ReservedKey, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_keysReservePUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysReservePUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysReservePUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_keysReservePUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  FString Field_poolId;

  FString Field_eventId;

  FString Field_userEmail;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_keysIssuePUT_Delegate, const FHivepos_IssuedKey, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_keysIssuePUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysIssuePUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysIssuePUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_keysIssuePUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_keysByReservedEmailGET_Delegate, const TArray<FHivepos_LicenseKey>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_keysByReservedEmailGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysByReservedEmailGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysByReservedEmailGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_keysByReservedEmailGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_LicenseKey_keysByIssuedEmailGET_Delegate, const TArray<FHivepos_LicenseKey>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_LicenseKey_keysByIssuedEmailGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysByIssuedEmailGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_LicenseKey_keysByIssuedEmailGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_LicenseKey_keysByIssuedEmailGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Product_productGET_Delegate, const FHivepos_ProductPointOfSale, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Product_productGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Product_productGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Product_productGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Product_productGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fpos_Product_productPOST_Delegate, const FHivepos_ProductPointOfSale, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Upos_Product_productPOST : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fpos_Product_productPOST_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fpos_Product_productPOST_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Point of Sale")
	static Upos_Product_productPOST* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  FString Field_currencyCode;

  int32 Field_currencyUnits;

  FString Field_licenseKeyPoolId;
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share PaymentOperation"))
struct FHiverevenue_share_PaymentOperation
{
	GENERATED_BODY()
...
struct FHiverevenue_share_InvoicePayment
{
  ...
  UPROPERTY(BlueprintReadOnly)
  FHiverevenue_share_PaymentOperation currentOperation;

  UPROPERTY(BlueprintReadOnly)
  bool stripeEnabled;

  UPROPERTY(BlueprintReadOnly)
  bool stripeDidPreAuth;

  UPROPERTY(BlueprintReadOnly)
  FString /* JSON STRING */ stripeJson;
...
struct FHiverevenue_share_PaymentOperation DeserializeFHiverevenue_share_PaymentOperation(TSharedPtr<FJsonObject> obj);
...
struct FHiverevenue_share_RecipientTransaction
{
  ...
  UPROPERTY(BlueprintReadOnly)
  FString taxTransactionId;

  UPROPERTY(BlueprintReadOnly)
  FString taxTransactionForId;
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share RecipientBalance"))
struct FHiverevenue_share_RecipientBalance
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  int32 balanceFractionalDivisor;
...
struct FHiverevenue_share_Recipient
{
  ...
  UPROPERTY(BlueprintReadOnly)
  TArray<FHiverevenue_share_RecipientBalance> balances;
...
struct FHiverevenue_share_RecipientBalance DeserializeFHiverevenue_share_RecipientBalance(TSharedPtr<FJsonObject> obj);
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share PaginatedRecipientTransactions"))
struct FHiverevenue_share_PaginatedRecipientTransactions
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  TArray<FHiverevenue_share_RecipientTransaction> results;

};

struct FHiverevenue_share_PaginatedRecipientTransactions DeserializeFHiverevenue_share_PaginatedRecipientTransactions(TSharedPtr<FJsonObject> obj);
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share InvoicePaymentStripeStatus"))
struct FHiverevenue_share_InvoicePaymentStripeStatus
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  TArray<FString> currenciesSupported;

  UPROPERTY(BlueprintReadOnly)
  bool hasMultipleCurrencies;

  UPROPERTY(BlueprintReadOnly)
  FString publicPaymentLink;

};

struct FHiverevenue_share_InvoicePaymentStripeStatus DeserializeFHiverevenue_share_InvoicePaymentStripeStatus(TSharedPtr<FJsonObject> obj);

USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share PublicInvoicePaymentLineItem"))
struct FHiverevenue_share_PublicInvoicePaymentLineItem
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Revenue Share PublicInvoicePayment"))
struct FHiverevenue_share_PublicInvoicePayment
{
	GENERATED_BODY()
  ...
  UPROPERTY(BlueprintReadOnly)
  FString stripePublicKey;

  UPROPERTY(BlueprintReadOnly)
  int32 stripeAmount;

  UPROPERTY(BlueprintReadOnly)
  FString stripeCurrency;

  UPROPERTY(BlueprintReadOnly)
  TArray<FHiverevenue_share_PublicInvoicePaymentLineItem> lineItems;
...
struct FHiverevenue_share_PublicInvoicePayment DeserializeFHiverevenue_share_PublicInvoicePayment(TSharedPtr<FJsonObject> obj);

struct FHiverevenue_share_PublicInvoicePaymentLineItem DeserializeFHiverevenue_share_PublicInvoicePaymentLineItem(TSharedPtr<FJsonObject> obj);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Invoice_invoicePaymentProcessPUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Invoice_invoicePaymentProcessPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentProcessPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentProcessPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Incrementally processes a payment, creating or archiving recipient transactions as needed", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Invoice_invoicePaymentProcessPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Invoice_invoicePaymentProgressGET_Delegate, const FHiverevenue_share_PaymentOperation, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Invoice_invoicePaymentProgressGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentProgressGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentProgressGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Gets the current operation on the payment", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Invoice_invoicePaymentProgressGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Invoice_invoicePaymentRequeuePUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Invoice_invoicePaymentRequeuePUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentRequeuePUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Invoice_invoicePaymentRequeuePUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Requeues the payment for processing", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Invoice_invoicePaymentRequeuePUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Recipient_recipientTransactionsGET_Delegate, const FHiverevenue_share_PaginatedRecipientTransactions, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Recipient_recipientTransactionsGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionsGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionsGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Retrieves a list of transactions against a recipient", ToolTip="Retrieves a paginated list of recipient transactions from the system."), Category="HiveMP|Revenue Share")
	static Urevenue_share_Recipient_recipientTransactionsGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Recipient_recipientTransactionGET_Delegate, const FHiverevenue_share_RecipientTransaction, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Recipient_recipientTransactionGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Returns information about the specified transaction", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Recipient_recipientTransactionGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  FString Field_transactionId;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Recipient_recipientTransactionPUT_Delegate, const FHiverevenue_share_RecipientTransaction, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Recipient_recipientTransactionPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Creates a new custom transaction against a recipient", ToolTip="Creates a new custom transaction against a recipient; this is used to pay down recipient balances when recipients have been paid."), Category="HiveMP|Revenue Share")
	static Urevenue_share_Recipient_recipientTransactionPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  bool Field_generateTaxTransaction;

  int32 Field_taxAmount;

  int32 Field_taxAmountFractionalDivisor;

  FString Field_taxRecipientId;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Recipient_recipientTransactionDELETE_Delegate, const FHiverevenue_share_RecipientTransaction, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Recipient_recipientTransactionDELETE : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionDELETE_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Recipient_recipientTransactionDELETE_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Archives a custom transaction on a recipient", ToolTip="Archives a custom transaction on a recipient. You can not archive transactions from payments with this API; instead you\nneed to unpost the payment."), Category="HiveMP|Revenue Share")
	static Urevenue_share_Recipient_recipientTransactionDELETE* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Stripe_stripePaymentEnabledPOST_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Stripe_stripePaymentEnabledPOST : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentEnabledPOST_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentEnabledPOST_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Enables or disables whether this payment can be posted by someone paying
it via Stripe", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Stripe_stripePaymentEnabledPOST* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Stripe_stripePaymentStatusGET_Delegate, const FHiverevenue_share_InvoicePaymentStripeStatus, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Stripe_stripePaymentStatusGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentStatusGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentStatusGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="Gets the Stripe information about a given payment", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Stripe_stripePaymentStatusGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Stripe_stripePaymentGET_Delegate, const FHiverevenue_share_PublicInvoicePayment, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Stripe_stripePaymentGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Stripe_stripePaymentGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
private:
  ...
  FString Field_paymentToken;

};


DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Frevenue_share_Stripe_stripePaymentPUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Urevenue_share_Stripe_stripePaymentPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Frevenue_share_Stripe_stripePaymentPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Revenue Share")
	static Urevenue_share_Stripe_stripePaymentPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
USTRUCT(BlueprintType, meta=(DisplayName="HiveMP Search InternalSearchResult"))
struct FHivesearch_InternalSearchResult
{
	GENERATED_BODY()
...
struct FHivesearch_InternalSearchResult DeserializeFHivesearch_InternalSearchResult(TSharedPtr<FJsonObject> obj);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Cluster_internalSearchGET_Delegate, const TArray<FHivesearch_InternalSearchResult>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Cluster_internalSearchGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalSearchGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalSearchGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Cluster_internalSearchGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Cluster_internalIndexPUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Cluster_internalIndexPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalIndexPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalIndexPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Cluster_internalIndexPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Cluster_internalIndexDELETE_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Cluster_internalIndexDELETE : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalIndexDELETE_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Cluster_internalIndexDELETE_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Cluster_internalIndexDELETE* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Search_searchGET_Delegate, const TArray<FHivesearch_InternalSearchResult>&, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Search_searchGET : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_searchGET_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_searchGET_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Search_searchGET* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Search_indexPUT_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Search_indexPUT : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_indexPUT_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_indexPUT_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Search_indexPUT* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(Fsearch_Search_indexDELETE_Delegate, bool, Result, const FHiveApiError&, Error);

UCLASS(MinimalAPI)
class Usearch_Search_indexDELETE : public UOnlineBlueprintCallProxyBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_indexDELETE_Delegate OnSuccess;

	UPROPERTY(BlueprintAssignable)
	Fsearch_Search_indexDELETE_Delegate OnFailure;

	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly = "true", WorldContext="WorldContextObject", DisplayName="", ToolTip=""), Category="HiveMP|Search")
	static Usearch_Search_indexDELETE* PerformHiveCall(
		UObject* WorldContextObject,
    FString ApiKey
