...
struct FHiveintegration_StripeIntegrationDetails DeserializeFHiveintegration_StripeIntegrationDetails(const TSharedPtr<FJsonObject> obj)
{
  struct FHiveintegration_StripeIntegrationDetails Target;


  bool F_enabled;
  if (obj->TryGetBoolField(TEXT("enabled"), F_enabled))
  {
    Target.enabled = (bool)F_enabled;
  }

  FString F_encryptedPublicKey;
  if (obj->TryGetStringField(TEXT("encryptedPublicKey"), F_encryptedPublicKey))
  {
    Target.encryptedPublicKey = F_encryptedPublicKey;
  }

  FString F_encryptedSecretKey;
  if (obj->TryGetStringField(TEXT("encryptedSecretKey"), F_encryptedSecretKey))
  {
    Target.encryptedSecretKey = F_encryptedSecretKey;
  }

  return Target;
}

struct FHiveintegration_StripeIntegrationStatus DeserializeFHiveintegration_StripeIntegrationStatus(const TSharedPtr<FJsonObject> obj)
{
  struct FHiveintegration_StripeIntegrationStatus Target;


  FString F_publicKey;
  if (obj->TryGetStringField(TEXT("publicKey"), F_publicKey))
  {
    Target.publicKey = F_publicKey;
  }
  ...
  bool F_configured;
  if (obj->TryGetBoolField(TEXT("configured"), F_configured))
  {
    Target.configured = (bool)F_configured;
  }
...
Uintegration_Stripe_stripeGET::Uintegration_Stripe_stripeGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Uintegration_Stripe_stripeGET* Uintegration_Stripe_stripeGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey

)
{
  Uintegration_Stripe_stripeGET* Proxy = NewObject<Uintegration_Stripe_stripeGET>();
...
void Uintegration_Stripe_stripeGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] integration /stripe get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://integration-api.hivemp.com/v1/stripe?")

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Uintegration_Stripe_stripeGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiveintegration_StripeIntegrationDetails(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] integration /stripe get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiveintegration_StripeIntegrationDetails(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] integration /stripe get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Uintegration_Stripe_stripeGET>(this));
  HttpRequest->ProcessRequest();
}


Uintegration_Stripe_stripePUT::Uintegration_Stripe_stripePUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Uintegration_Stripe_stripePUT* Uintegration_Stripe_stripePUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Uintegration_Stripe_stripePUT* Proxy = NewObject<Uintegration_Stripe_stripePUT>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_publicKey = publicKey;

  Proxy->Field_secretKey = secretKey;

  return Proxy;
}

void Uintegration_Stripe_stripePUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] integration /stripe put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://integration-api.hivemp.com/v1/stripe?publicKey=%s&secretKey=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_publicKey)

    , *FGenericPlatformHttp::UrlEncode(this->Field_secretKey)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Uintegration_Stripe_stripePUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] integration /stripe put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] integration /stripe put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Uintegration_Stripe_stripePUT>(this));
  HttpRequest->ProcessRequest();
}


Uintegration_Stripe_stripeDELETE::Uintegration_Stripe_stripeDELETE(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Uintegration_Stripe_stripeDELETE* Uintegration_Stripe_stripeDELETE::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey

)
{
  Uintegration_Stripe_stripeDELETE* Proxy = NewObject<Uintegration_Stripe_stripeDELETE>();
...
void Uintegration_Stripe_stripeDELETE::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] integration /stripe delete"));
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("delete"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Uintegration_Stripe_stripeDELETE> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe delete: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe delete: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] integration /stripe delete: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] integration /stripe delete"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Uintegration_Stripe_stripeDELETE>(this));
  HttpRequest->ProcessRequest();
}


Uintegration_Stripe_stripeTogglePUT::Uintegration_Stripe_stripeTogglePUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Uintegration_Stripe_stripeTogglePUT* Uintegration_Stripe_stripeTogglePUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Uintegration_Stripe_stripeTogglePUT* Proxy = NewObject<Uintegration_Stripe_stripeTogglePUT>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_enabled = enabled;

  return Proxy;
}

void Uintegration_Stripe_stripeTogglePUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] integration /stripe/toggle put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://integration-api.hivemp.com/v1/stripe/toggle?enabled=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_enabled ? TEXT("true") : TEXT("false"))

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Uintegration_Stripe_stripeTogglePUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe/toggle put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe/toggle put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] integration /stripe/toggle put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] integration /stripe/toggle put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Uintegration_Stripe_stripeTogglePUT>(this));
  HttpRequest->ProcessRequest();
}


Uintegration_Stripe_stripeStatusGET::Uintegration_Stripe_stripeStatusGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Uintegration_Stripe_stripeStatusGET* Uintegration_Stripe_stripeStatusGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey

)
{
  Uintegration_Stripe_stripeStatusGET* Proxy = NewObject<Uintegration_Stripe_stripeStatusGET>();
...
void Uintegration_Stripe_stripeStatusGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] integration /stripe/status get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://integration-api.hivemp.com/v1/stripe/status?")

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Uintegration_Stripe_stripeStatusGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe/status get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] integration /stripe/status get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiveintegration_StripeIntegrationStatus(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] integration /stripe/status get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiveintegration_StripeIntegrationStatus(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] integration /stripe/status get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Uintegration_Stripe_stripeStatusGET>(this));
  HttpRequest->ProcessRequest();
}
...
struct FHivereporting_ReportData DeserializeFHivereporting_ReportData(const TSharedPtr<FJsonObject> obj)
{
  ...
  {
    Target.metadata = alizeFHivereporting_ReportMetadata(*F_metadata);
  }

  const TSharedPtr<FJsonObject>* F_timeSeriesData;
  if (obj->TryGetObjectField(TEXT("timeSeriesData"), F_timeSeriesData))
  {
    Target.timeSeriesData = alizeFHivereporting_TimeSeriesData(*F_timeSeriesData);
  }
...
struct FHivepos_PaginatedPointOfSaleEvents DeserializeFHivepos_PaginatedPointOfSaleEvents(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_PaginatedPointOfSaleEvents Target;
  ...
  if (obj->TryGetArrayField(TEXT("results"), F_results))
  {
    for (int i = 0; i < F_results->Num(); i++)
    {
      ...
      if ((*F_results)[i]->TryGetObject(A_results))
      {
        Target.results.Add(DeserializeFHivepos_PointOfSaleEvent(*A_results));
      }
...
struct FHivepos_PointOfSaleEvent DeserializeFHivepos_PointOfSaleEvent(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_PointOfSaleEvent Target;
  ...
  double F_eventStartUtc;
  if (obj->TryGetNumberField(TEXT("eventStartUtc"), F_eventStartUtc))
  {
    Target.eventStartUtc = (int32)F_eventStartUtc;
  }

  double F_eventEndUtc;
  if (obj->TryGetNumberField(TEXT("eventEndUtc"), F_eventEndUtc))
  {
    Target.eventEndUtc = (int32)F_eventEndUtc;
  }

  const TArray<TSharedPtr<FJsonValue>>* F_productIds;
  if (obj->TryGetArrayField(TEXT("productIds"), F_productIds))
  {
    for (int i = 0; i < F_productIds->Num(); i++)
    {

      FString A_productIds;
      if ((*F_productIds)[i]->TryGetString(A_productIds))
      {
        Target.productIds.Add(A_productIds);
      }
...
struct FHivepos_PointOfSaleEventSearchResult DeserializeFHivepos_PointOfSaleEventSearchResult(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_PointOfSaleEventSearchResult Target;
...
struct FHivepos_PaginatedLicenseKeyPools DeserializeFHivepos_PaginatedLicenseKeyPools(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_PaginatedLicenseKeyPools Target;
  ...
  if (obj->TryGetArrayField(TEXT("results"), F_results))
  {
    for (int i = 0; i < F_results->Num(); i++)
    {
      ...
      if ((*F_results)[i]->TryGetObject(A_results))
      {
        Target.results.Add(DeserializeFHivepos_LicenseKeyPool(*A_results));
      }
...
struct FHivepos_LicenseKeyPool DeserializeFHivepos_LicenseKeyPool(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_LicenseKeyPool Target;
  ...
  double F_availableKeys;
  if (obj->TryGetNumberField(TEXT("availableKeys"), F_availableKeys))
  {
    Target.availableKeys = (int32)F_availableKeys;
  }

  double F_reservedKeys;
  if (obj->TryGetNumberField(TEXT("reservedKeys"), F_reservedKeys))
  {
    Target.reservedKeys = (int32)F_reservedKeys;
  }

  double F_issuedKeys;
  if (obj->TryGetNumberField(TEXT("issuedKeys"), F_issuedKeys))
  {
    Target.issuedKeys = (int32)F_issuedKeys;
  }

  double F_activatedKeys;
  if (obj->TryGetNumberField(TEXT("activatedKeys"), F_activatedKeys))
  {
    Target.activatedKeys = (int32)F_activatedKeys;
  }

  return Target;
}

struct FHivepos_LicenseKeyPoolSearchResult DeserializeFHivepos_LicenseKeyPoolSearchResult(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_LicenseKeyPoolSearchResult Target;
...
struct FHivepos_PoolInsertResults DeserializeFHivepos_PoolInsertResults(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_PoolInsertResults Target;


  double F_newKeys;
  if (obj->TryGetNumberField(TEXT("newKeys"), F_newKeys))
  {
    Target.newKeys = (int32)F_newKeys;
  }

  FString F_results;
  if (obj->TryGetStringField(TEXT("results"), F_results))
  {
    Target.results = F_results;
  }

  return Target;
}

struct FHivepos_ReservedKey DeserializeFHivepos_ReservedKey(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_ReservedKey Target;


  FString F_licenseKeyPoolId;
  if (obj->TryGetStringField(TEXT("licenseKeyPoolId"), F_licenseKeyPoolId))
  {
    Target.licenseKeyPoolId = F_licenseKeyPoolId;
  }

  FString F_licenseKey;
  if (obj->TryGetStringField(TEXT("licenseKey"), F_licenseKey))
  {
    Target.licenseKey = F_licenseKey;
  }

  FString F_reservedAtEventId;
  if (obj->TryGetStringField(TEXT("reservedAtEventId"), F_reservedAtEventId))
  {
    Target.reservedAtEventId = F_reservedAtEventId;
  }

  FString F_reservedForEmail;
  if (obj->TryGetStringField(TEXT("reservedForEmail"), F_reservedForEmail))
  {
    Target.reservedForEmail = F_reservedForEmail;
  }

  double F_reservedOnDate;
  if (obj->TryGetNumberField(TEXT("reservedOnDate"), F_reservedOnDate))
  {
    Target.reservedOnDate = (int32)F_reservedOnDate;
  }

  return Target;
}

struct FHivepos_IssuedKey DeserializeFHivepos_IssuedKey(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_IssuedKey Target;
  ...
  FString F_issuedAtEventId;
  if (obj->TryGetStringField(TEXT("issuedAtEventId"), F_issuedAtEventId))
  {
    Target.issuedAtEventId = F_issuedAtEventId;
  }

  FString F_issuedToEmail;
  if (obj->TryGetStringField(TEXT("issuedToEmail"), F_issuedToEmail))
  {
    Target.issuedToEmail = F_issuedToEmail;
  }

  double F_issuedOnDate;
  if (obj->TryGetNumberField(TEXT("issuedOnDate"), F_issuedOnDate))
  {
    Target.issuedOnDate = (int32)F_issuedOnDate;
  }

  return Target;
}

struct FHivepos_LicenseKey DeserializeFHivepos_LicenseKey(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_LicenseKey Target;
  ...
  FString F_licensePoolId;
  if (obj->TryGetStringField(TEXT("licensePoolId"), F_licensePoolId))
  {
    Target.licensePoolId = F_licensePoolId;
  }

  FString F_reservedEventId;
  if (obj->TryGetStringField(TEXT("reservedEventId"), F_reservedEventId))
  {
    Target.reservedEventId = F_reservedEventId;
  }
  ...
  double F_dateReservedUtc;
  if (obj->TryGetNumberField(TEXT("dateReservedUtc"), F_dateReservedUtc))
  {
    Target.dateReservedUtc = (int32)F_dateReservedUtc;
  }

  FString F_issuedEventId;
  if (obj->TryGetStringField(TEXT("issuedEventId"), F_issuedEventId))
  {
    Target.issuedEventId = F_issuedEventId;
  }
  ...
  double F_dateIssuedUtc;
  if (obj->TryGetNumberField(TEXT("dateIssuedUtc"), F_dateIssuedUtc))
  {
    Target.dateIssuedUtc = (int32)F_dateIssuedUtc;
  }
  ...
  double F_dateActivatedUtc;
  if (obj->TryGetNumberField(TEXT("dateActivatedUtc"), F_dateActivatedUtc))
  {
    Target.dateActivatedUtc = (int32)F_dateActivatedUtc;
  }

  return Target;
}

struct FHivepos_ProductPointOfSale DeserializeFHivepos_ProductPointOfSale(const TSharedPtr<FJsonObject> obj)
{
  struct FHivepos_ProductPointOfSale Target;
  ...
  FString F_currencyCode;
  if (obj->TryGetStringField(TEXT("currencyCode"), F_currencyCode))
  {
    Target.currencyCode = F_currencyCode;
  }

  double F_currencyUnits;
  if (obj->TryGetNumberField(TEXT("currencyUnits"), F_currencyUnits))
  {
    Target.currencyUnits = (int32)F_currencyUnits;
  }
...
Upos_Event_eventsGET::Upos_Event_eventsGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Event_eventsGET* Upos_Event_eventsGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Event_eventsGET* Proxy = NewObject<Upos_Event_eventsGET>();
...
void Upos_Event_eventsGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /events get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/events?start=%s&limit=%i&showHidden=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Event_eventsGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /events get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /events get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PaginatedPointOfSaleEvents(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /events get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_PaginatedPointOfSaleEvents(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /events get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Event_eventsGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_Event_eventsSearchGET::Upos_Event_eventsSearchGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Event_eventsSearchGET* Upos_Event_eventsSearchGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Event_eventsSearchGET* Proxy = NewObject<Upos_Event_eventsSearchGET>();
...
void Upos_Event_eventsSearchGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /events/search get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/events/search?text=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Event_eventsSearchGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /events/search get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /events/search get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivepos_PointOfSaleEventSearchResult>(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /events/search get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				TArray<FHivepos_PointOfSaleEventSearchResult> Result;
				for (int i = 0; i < JsonArray->Num(); i++)
				{
					const TSharedPtr<FJsonObject>* JsonArrayObj;
					if ((*JsonArray)[i]->TryGetObject(JsonArrayObj))
					{
						Result.Add(DeserializeFHivepos_PointOfSaleEventSearchResult(*JsonArrayObj));
					}

				}
				UE_LOG_HIVE(Warning, TEXT("[success] pos /events/search get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Event_eventsSearchGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_Event_eventGET::Upos_Event_eventGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Event_eventGET* Upos_Event_eventGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Event_eventGET* Proxy = NewObject<Upos_Event_eventGET>();
...
void Upos_Event_eventGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /event get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/event?id=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Event_eventGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PointOfSaleEvent(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /event get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_PointOfSaleEvent(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /event get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Event_eventGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_Event_eventPUT::Upos_Event_eventPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Event_eventPUT* Upos_Event_eventPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Event_eventPUT* Proxy = NewObject<Upos_Event_eventPUT>();
  ...
  Proxy->Field_eventStartUtc = eventStartUtc;

  Proxy->Field_eventEndUtc = eventEndUtc;

  Proxy->Field_productIds = TArray<FString>(productIds);

  return Proxy;
}

void Upos_Event_eventPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /event put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/event?name=%s&visible=%s&eventStartUtc=%i&eventEndUtc=%i")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Event_eventPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PointOfSaleEvent(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /event put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHivepos_PointOfSaleEvent(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /event put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Event_eventPUT>(this));
  HttpRequest->ProcessRequest();
}


Upos_Event_eventPOST::Upos_Event_eventPOST(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Event_eventPOST* Upos_Event_eventPOST::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Event_eventPOST* Proxy = NewObject<Upos_Event_eventPOST>();
...
void Upos_Event_eventPOST::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /event post"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/event?id=%s&name=%s&visible=%s&eventStartUtc=%i&eventEndUtc=%i")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("post"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Event_eventPOST> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event post: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /event post: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PointOfSaleEvent(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /event post: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHivepos_PointOfSaleEvent(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /event post"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Event_eventPOST>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_poolsGET::Upos_LicenseKey_poolsGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_poolsGET* Upos_LicenseKey_poolsGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_poolsGET* Proxy = NewObject<Upos_LicenseKey_poolsGET>();
...
void Upos_LicenseKey_poolsGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /pools get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/pools?start=%s&limit=%i&showHidden=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_poolsGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pools get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pools get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PaginatedLicenseKeyPools(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /pools get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_PaginatedLicenseKeyPools(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /pools get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_poolsGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_poolsSearchGET::Upos_LicenseKey_poolsSearchGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_poolsSearchGET* Upos_LicenseKey_poolsSearchGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_poolsSearchGET* Proxy = NewObject<Upos_LicenseKey_poolsSearchGET>();
...
void Upos_LicenseKey_poolsSearchGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /pools/search get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/pools/search?text=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_poolsSearchGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pools/search get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pools/search get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivepos_LicenseKeyPoolSearchResult>(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /pools/search get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				TArray<FHivepos_LicenseKeyPoolSearchResult> Result;
				for (int i = 0; i < JsonArray->Num(); i++)
				{
					const TSharedPtr<FJsonObject>* JsonArrayObj;
					if ((*JsonArray)[i]->TryGetObject(JsonArrayObj))
					{
						Result.Add(DeserializeFHivepos_LicenseKeyPoolSearchResult(*JsonArrayObj));
					}

				}
				UE_LOG_HIVE(Warning, TEXT("[success] pos /pools/search get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_poolsSearchGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_poolGET::Upos_LicenseKey_poolGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_poolGET* Upos_LicenseKey_poolGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_poolGET* Proxy = NewObject<Upos_LicenseKey_poolGET>();
...
void Upos_LicenseKey_poolGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /pool get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/pool?id=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_poolGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_LicenseKeyPool(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /pool get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_LicenseKeyPool(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /pool get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_poolGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_poolPUT::Upos_LicenseKey_poolPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_poolPUT* Upos_LicenseKey_poolPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_poolPUT* Proxy = NewObject<Upos_LicenseKey_poolPUT>();
...
void Upos_LicenseKey_poolPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /pool put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/pool?name=%s&description=%s&visible=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_poolPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_LicenseKeyPool(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /pool put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHivepos_LicenseKeyPool(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /pool put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_poolPUT>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_poolPOST::Upos_LicenseKey_poolPOST(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_poolPOST* Upos_LicenseKey_poolPOST::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_poolPOST* Proxy = NewObject<Upos_LicenseKey_poolPOST>();
...
void Upos_LicenseKey_poolPOST::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /pool post"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/pool?id=%s&name=%s&description=%s&visible=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("post"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_poolPOST> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool post: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /pool post: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_LicenseKeyPool(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /pool post: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHivepos_LicenseKeyPool(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /pool post"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_poolPOST>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_keysPUT::Upos_LicenseKey_keysPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_keysPUT* Upos_LicenseKey_keysPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_keysPUT* Proxy = NewObject<Upos_LicenseKey_keysPUT>();
  ...
  Proxy->Field_keys = TArray<FString>(keys);

  return Proxy;
}

void Upos_LicenseKey_keysPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /keys put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/keys?id=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_keysPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_PoolInsertResults(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /keys put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_PoolInsertResults(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /keys put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_keysPUT>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_keysReservePUT::Upos_LicenseKey_keysReservePUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_keysReservePUT* Upos_LicenseKey_keysReservePUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_keysReservePUT* Proxy = NewObject<Upos_LicenseKey_keysReservePUT>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_poolId = poolId;

  Proxy->Field_eventId = eventId;

  Proxy->Field_userEmail = userEmail;

  return Proxy;
}

void Upos_LicenseKey_keysReservePUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /keys/reserve put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/keys/reserve?poolId=%s&eventId=%s&userEmail=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_poolId)

    , *FGenericPlatformHttp::UrlEncode(this->Field_eventId)

    , *FGenericPlatformHttp::UrlEncode(this->Field_userEmail)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_keysReservePUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/reserve put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/reserve put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_ReservedKey(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /keys/reserve put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_ReservedKey(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /keys/reserve put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_keysReservePUT>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_keysIssuePUT::Upos_LicenseKey_keysIssuePUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_keysIssuePUT* Upos_LicenseKey_keysIssuePUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_keysIssuePUT* Proxy = NewObject<Upos_LicenseKey_keysIssuePUT>();
...
void Upos_LicenseKey_keysIssuePUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /keys/issue put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/keys/issue?poolId=%s&eventId=%s&key=%s&userEmail=%s&notes=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_keysIssuePUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/issue put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/issue put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_IssuedKey(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /keys/issue put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_IssuedKey(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /keys/issue put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_keysIssuePUT>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_keysByReservedEmailGET::Upos_LicenseKey_keysByReservedEmailGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_keysByReservedEmailGET* Upos_LicenseKey_keysByReservedEmailGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_keysByReservedEmailGET* Proxy = NewObject<Upos_LicenseKey_keysByReservedEmailGET>();
...
void Upos_LicenseKey_keysByReservedEmailGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /keys/byReservedEmail get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/keys/byReservedEmail?poolId=%s&email=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_keysByReservedEmailGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/byReservedEmail get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/byReservedEmail get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivepos_LicenseKey>(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /keys/byReservedEmail get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				TArray<FHivepos_LicenseKey> Result;
				for (int i = 0; i < JsonArray->Num(); i++)
				{
					const TSharedPtr<FJsonObject>* JsonArrayObj;
					if ((*JsonArray)[i]->TryGetObject(JsonArrayObj))
					{
						Result.Add(DeserializeFHivepos_LicenseKey(*JsonArrayObj));
					}

				}
				UE_LOG_HIVE(Warning, TEXT("[success] pos /keys/byReservedEmail get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_keysByReservedEmailGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_LicenseKey_keysByIssuedEmailGET::Upos_LicenseKey_keysByIssuedEmailGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_LicenseKey_keysByIssuedEmailGET* Upos_LicenseKey_keysByIssuedEmailGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_LicenseKey_keysByIssuedEmailGET* Proxy = NewObject<Upos_LicenseKey_keysByIssuedEmailGET>();
...
void Upos_LicenseKey_keysByIssuedEmailGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /keys/byIssuedEmail get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/keys/byIssuedEmail?poolId=%s&email=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_LicenseKey_keysByIssuedEmailGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/byIssuedEmail get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /keys/byIssuedEmail get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivepos_LicenseKey>(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /keys/byIssuedEmail get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				...
				UE_LOG_HIVE(Warning, TEXT("[success] pos /keys/byIssuedEmail get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_LicenseKey_keysByIssuedEmailGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_Product_productGET::Upos_Product_productGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Product_productGET* Upos_Product_productGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Upos_Product_productGET* Proxy = NewObject<Upos_Product_productGET>();
...
void Upos_Product_productGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /product get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/product?productId=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Product_productGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /product get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /product get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_ProductPointOfSale(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] pos /product get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHivepos_ProductPointOfSale(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /product get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Product_productGET>(this));
  HttpRequest->ProcessRequest();
}


Upos_Product_productPOST::Upos_Product_productPOST(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Upos_Product_productPOST* Upos_Product_productPOST::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
  ...
  , FString licenseKeyPoolId

)
{
  Upos_Product_productPOST* Proxy = NewObject<Upos_Product_productPOST>();
  ...
  Proxy->Field_currencyCode = currencyCode;

  Proxy->Field_currencyUnits = currencyUnits;

  Proxy->Field_licenseKeyPoolId = licenseKeyPoolId;

  return Proxy;
}

void Upos_Product_productPOST::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] pos /product post"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://pos-api.hivemp.com/v1/product?productId=%s&enabled=%s&currencyCode=%s&currencyUnits=%i&licenseKeyPoolId=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_productId)

    , *FGenericPlatformHttp::UrlEncode(this->Field_enabled ? TEXT("true") : TEXT("false"))

    , *FGenericPlatformHttp::UrlEncode(this->Field_currencyCode)

    , *FGenericPlatformHttp::UrlEncode(this->Field_licenseKeyPoolId)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("post"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Upos_Product_productPOST> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] pos /product post: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] pos /product post: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHivepos_ProductPointOfSale(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] pos /product post: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHivepos_ProductPointOfSale(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] pos /product post"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Upos_Product_productPOST>(this));
  HttpRequest->ProcessRequest();
}
...
struct FHiverevenue_share_InvoicePayment DeserializeFHiverevenue_share_InvoicePayment(const TSharedPtr<FJsonObject> obj)
{
  ...
  const TSharedPtr<FJsonObject>* F_currentOperation;
  if (obj->TryGetObjectField(TEXT("currentOperation"), F_currentOperation))
  {
    Target.currentOperation = alizeFHiverevenue_share_PaymentOperation(*F_currentOperation);
  }

  bool F_stripeEnabled;
  if (obj->TryGetBoolField(TEXT("stripeEnabled"), F_stripeEnabled))
  {
    Target.stripeEnabled = (bool)F_stripeEnabled;
  }

  bool F_stripeDidPreAuth;
  if (obj->TryGetBoolField(TEXT("stripeDidPreAuth"), F_stripeDidPreAuth))
  {
    Target.stripeDidPreAuth = (bool)F_stripeDidPreAuth;
  }

  FString F_stripeJson;
  if (obj->TryGetStringField(TEXT("stripeJson"), F_stripeJson))
  {
    Target.stripeJson = F_stripeJson;
  }
...
struct FHiverevenue_share_PaymentOperation DeserializeFHiverevenue_share_PaymentOperation(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_PaymentOperation Target;
  ...
  double F_lastProcessedUtc;
  if (obj->TryGetNumberField(TEXT("lastProcessedUtc"), F_lastProcessedUtc))
  {
    Target.lastProcessedUtc = (int32)F_lastProcessedUtc;
  }

  double F_percentComplete;
  if (obj->TryGetNumberField(TEXT("percentComplete"), F_percentComplete))
  {
    Target.percentComplete = (float)F_percentComplete;
  }
...
struct FHiverevenue_share_RecipientTransaction DeserializeFHiverevenue_share_RecipientTransaction(const TSharedPtr<FJsonObject> obj)
{
  ...
  FString F_taxTransactionId;
  if (obj->TryGetStringField(TEXT("taxTransactionId"), F_taxTransactionId))
  {
    Target.taxTransactionId = F_taxTransactionId;
  }

  FString F_taxTransactionForId;
  if (obj->TryGetStringField(TEXT("taxTransactionForId"), F_taxTransactionForId))
  {
    Target.taxTransactionForId = F_taxTransactionForId;
  }

  double F_taxAmount;
  if (obj->TryGetNumberField(TEXT("taxAmount"), F_taxAmount))
  {
    Target.taxAmount = (int32)F_taxAmount;
  }

  double F_taxAmountFractionalDivisor;
  if (obj->TryGetNumberField(TEXT("taxAmountFractionalDivisor"), F_taxAmountFractionalDivisor))
  {
    Target.taxAmountFractionalDivisor = (int32)F_taxAmountFractionalDivisor;
  }

  FString F_taxRecipientId;
  if (obj->TryGetStringField(TEXT("taxRecipientId"), F_taxRecipientId))
  {
    Target.taxRecipientId = F_taxRecipientId;
  }
...
struct FHiverevenue_share_Recipient DeserializeFHiverevenue_share_Recipient(const TSharedPtr<FJsonObject> obj)
{
  ...
  const TArray<TSharedPtr<FJsonValue>>* F_balances;
  if (obj->TryGetArrayField(TEXT("balances"), F_balances))
  {
    for (int i = 0; i < F_balances->Num(); i++)
    {

      const TSharedPtr<FJsonObject>* A_balances;
      if ((*F_balances)[i]->TryGetObject(A_balances))
      {
        Target.balances.Add(DeserializeFHiverevenue_share_RecipientBalance(*A_balances));
      }
...
struct FHiverevenue_share_RecipientBalance DeserializeFHiverevenue_share_RecipientBalance(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_RecipientBalance Target;


  double F_balance;
  if (obj->TryGetNumberField(TEXT("balance"), F_balance))
  {
    Target.balance = (int32)F_balance;
  }

  double F_balanceFractionalDivisor;
  if (obj->TryGetNumberField(TEXT("balanceFractionalDivisor"), F_balanceFractionalDivisor))
  {
    Target.balanceFractionalDivisor = (int32)F_balanceFractionalDivisor;
  }
...
struct FHiverevenue_share_PaginatedRecipientTransactions DeserializeFHiverevenue_share_PaginatedRecipientTransactions(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_PaginatedRecipientTransactions Target;
  ...
  if (obj->TryGetArrayField(TEXT("results"), F_results))
  {
    for (int i = 0; i < F_results->Num(); i++)
    {
      ...
      if ((*F_results)[i]->TryGetObject(A_results))
      {
        Target.results.Add(DeserializeFHiverevenue_share_RecipientTransaction(*A_results));
      }
...
struct FHiverevenue_share_InvoicePaymentStripeStatus DeserializeFHiverevenue_share_InvoicePaymentStripeStatus(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_InvoicePaymentStripeStatus Target;


  bool F_isStripeAvailable;
  if (obj->TryGetBoolField(TEXT("isStripeAvailable"), F_isStripeAvailable))
  {
    Target.isStripeAvailable = (bool)F_isStripeAvailable;
  }

  bool F_isStripeEnabled;
  if (obj->TryGetBoolField(TEXT("isStripeEnabled"), F_isStripeEnabled))
  {
    Target.isStripeEnabled = (bool)F_isStripeEnabled;
  }

  bool F_isUnpaid;
  if (obj->TryGetBoolField(TEXT("isUnpaid"), F_isUnpaid))
  {
    Target.isUnpaid = (bool)F_isUnpaid;
  }

  bool F_isPaid;
  if (obj->TryGetBoolField(TEXT("isPaid"), F_isPaid))
  {
    Target.isPaid = (bool)F_isPaid;
  }

  bool F_isWaived;
  if (obj->TryGetBoolField(TEXT("isWaived"), F_isWaived))
  {
    Target.isWaived = (bool)F_isWaived;
  }

  bool F_isCurrencySupported;
  if (obj->TryGetBoolField(TEXT("isCurrencySupported"), F_isCurrencySupported))
  {
    Target.isCurrencySupported = (bool)F_isCurrencySupported;
  }

  const TArray<TSharedPtr<FJsonValue>>* F_currenciesSupported;
  if (obj->TryGetArrayField(TEXT("currenciesSupported"), F_currenciesSupported))
  {
    for (int i = 0; i < F_currenciesSupported->Num(); i++)
    {

      FString A_currenciesSupported;
      if ((*F_currenciesSupported)[i]->TryGetString(A_currenciesSupported))
      {
        Target.currenciesSupported.Add(A_currenciesSupported);
      }

    }
  }

  bool F_hasMultipleCurrencies;
  if (obj->TryGetBoolField(TEXT("hasMultipleCurrencies"), F_hasMultipleCurrencies))
  {
    Target.hasMultipleCurrencies = (bool)F_hasMultipleCurrencies;
  }

  FString F_publicPaymentLink;
  if (obj->TryGetStringField(TEXT("publicPaymentLink"), F_publicPaymentLink))
  {
    Target.publicPaymentLink = F_publicPaymentLink;
  }

  return Target;
}

struct FHiverevenue_share_PublicInvoicePayment DeserializeFHiverevenue_share_PublicInvoicePayment(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_PublicInvoicePayment Target;
  ...
  bool F_canPay;
  if (obj->TryGetBoolField(TEXT("canPay"), F_canPay))
  {
    Target.canPay = (bool)F_canPay;
  }

  FString F_stripePublicKey;
  if (obj->TryGetStringField(TEXT("stripePublicKey"), F_stripePublicKey))
  {
    Target.stripePublicKey = F_stripePublicKey;
  }

  double F_stripeAmount;
  if (obj->TryGetNumberField(TEXT("stripeAmount"), F_stripeAmount))
  {
    Target.stripeAmount = (int32)F_stripeAmount;
  }

  FString F_stripeCurrency;
  if (obj->TryGetStringField(TEXT("stripeCurrency"), F_stripeCurrency))
  {
    Target.stripeCurrency = F_stripeCurrency;
  }
  ...
  if (obj->TryGetArrayField(TEXT("lineItems"), F_lineItems))
  {
    for (int i = 0; i < F_lineItems->Num(); i++)
    {
      ...
      if ((*F_lineItems)[i]->TryGetObject(A_lineItems))
      {
        Target.lineItems.Add(DeserializeFHiverevenue_share_PublicInvoicePaymentLineItem(*A_lineItems));
      }

    }
  }

  FString F_totalAmount;
  if (obj->TryGetStringField(TEXT("totalAmount"), F_totalAmount))
  {
    Target.totalAmount = F_totalAmount;
  }

  FString F_totalCurrency;
  if (obj->TryGetStringField(TEXT("totalCurrency"), F_totalCurrency))
  {
    Target.totalCurrency = F_totalCurrency;
  }

  return Target;
}

struct FHiverevenue_share_PublicInvoicePaymentLineItem DeserializeFHiverevenue_share_PublicInvoicePaymentLineItem(const TSharedPtr<FJsonObject> obj)
{
  struct FHiverevenue_share_PublicInvoicePaymentLineItem Target;
  ...
  FString F_amount;
  if (obj->TryGetStringField(TEXT("amount"), F_amount))
  {
    Target.amount = F_amount;
  }
...
Urevenue_share_Invoice_invoicePaymentProcessPUT::Urevenue_share_Invoice_invoicePaymentProcessPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Invoice_invoicePaymentProcessPUT* Urevenue_share_Invoice_invoicePaymentProcessPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Invoice_invoicePaymentProcessPUT* Proxy = NewObject<Urevenue_share_Invoice_invoicePaymentProcessPUT>();
...
void Urevenue_share_Invoice_invoicePaymentProcessPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /invoice/payment/process put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/invoice/payment/process?paymentId=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentProcessPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/process put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/process put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /invoice/payment/process put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /invoice/payment/process put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentProcessPUT>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Invoice_invoicePaymentProgressGET::Urevenue_share_Invoice_invoicePaymentProgressGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Invoice_invoicePaymentProgressGET* Urevenue_share_Invoice_invoicePaymentProgressGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Invoice_invoicePaymentProgressGET* Proxy = NewObject<Urevenue_share_Invoice_invoicePaymentProgressGET>();
...
void Urevenue_share_Invoice_invoicePaymentProgressGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /invoice/payment/progress get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/invoice/payment/progress?paymentId=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentProgressGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/progress get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/progress get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_PaymentOperation(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /invoice/payment/progress get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiverevenue_share_PaymentOperation(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /invoice/payment/progress get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentProgressGET>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Invoice_invoicePaymentRequeuePUT::Urevenue_share_Invoice_invoicePaymentRequeuePUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Invoice_invoicePaymentRequeuePUT* Urevenue_share_Invoice_invoicePaymentRequeuePUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Invoice_invoicePaymentRequeuePUT* Proxy = NewObject<Urevenue_share_Invoice_invoicePaymentRequeuePUT>();
...
void Urevenue_share_Invoice_invoicePaymentRequeuePUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /invoice/payment/requeue put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/invoice/payment/requeue?paymentId=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentRequeuePUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/requeue put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /invoice/payment/requeue put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /invoice/payment/requeue put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /invoice/payment/requeue put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Urevenue_share_Invoice_invoicePaymentRequeuePUT>(this));
  HttpRequest->ProcessRequest();
}
...
Urevenue_share_Recipient_recipientTransactionsGET::Urevenue_share_Recipient_recipientTransactionsGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Recipient_recipientTransactionsGET* Urevenue_share_Recipient_recipientTransactionsGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Recipient_recipientTransactionsGET* Proxy = NewObject<Urevenue_share_Recipient_recipientTransactionsGET>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_recipientId = recipientId;
...
void Urevenue_share_Recipient_recipientTransactionsGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /recipient/transactions get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/recipient/transactions?recipientId=%s&start=%s&limit=%i&showHidden=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_recipientId)
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionsGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transactions get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transactions get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_PaginatedRecipientTransactions(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /recipient/transactions get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiverevenue_share_PaginatedRecipientTransactions(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /recipient/transactions get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionsGET>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Recipient_recipientTransactionGET::Urevenue_share_Recipient_recipientTransactionGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Recipient_recipientTransactionGET* Urevenue_share_Recipient_recipientTransactionGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Recipient_recipientTransactionGET* Proxy = NewObject<Urevenue_share_Recipient_recipientTransactionGET>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_transactionId = transactionId;

  return Proxy;
}

void Urevenue_share_Recipient_recipientTransactionGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /recipient/transaction get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/recipient/transaction?transactionId=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_transactionId)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_RecipientTransaction(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /recipient/transaction get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiverevenue_share_RecipientTransaction(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /recipient/transaction get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionGET>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Recipient_recipientTransactionPUT::Urevenue_share_Recipient_recipientTransactionPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Recipient_recipientTransactionPUT* Urevenue_share_Recipient_recipientTransactionPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
  ...
  , bool generateTaxTransaction

  , int32 taxAmount

  , int32 taxAmountFractionalDivisor

  , FString taxRecipientId

)
{
  Urevenue_share_Recipient_recipientTransactionPUT* Proxy = NewObject<Urevenue_share_Recipient_recipientTransactionPUT>();
  ...
  Proxy->Field_generateTaxTransaction = generateTaxTransaction;

  Proxy->Field_taxAmount = taxAmount;

  Proxy->Field_taxAmountFractionalDivisor = taxAmountFractionalDivisor;

  Proxy->Field_taxRecipientId = taxRecipientId;

  return Proxy;
}

void Urevenue_share_Recipient_recipientTransactionPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /recipient/transaction put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/recipient/transaction?recipientId=%s&title=%s&notes=%s&amount=%i&amountFractionalDivisor=%i&currency=%s&generateTaxTransaction=%s&taxAmount=%i&taxAmountFractionalDivisor=%i&taxRecipientId=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_recipientId)

    , *FGenericPlatformHttp::UrlEncode(this->Field_title)

    , *FGenericPlatformHttp::UrlEncode(this->Field_notes)

    , *FGenericPlatformHttp::UrlEncode(this->Field_currency)

    , *FGenericPlatformHttp::UrlEncode(this->Field_generateTaxTransaction ? TEXT("true") : TEXT("false"))

    , *FGenericPlatformHttp::UrlEncode(this->Field_taxRecipientId)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_RecipientTransaction(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /recipient/transaction put: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHiverevenue_share_RecipientTransaction(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /recipient/transaction put"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionPUT>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Recipient_recipientTransactionDELETE::Urevenue_share_Recipient_recipientTransactionDELETE(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Recipient_recipientTransactionDELETE* Urevenue_share_Recipient_recipientTransactionDELETE::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Recipient_recipientTransactionDELETE* Proxy = NewObject<Urevenue_share_Recipient_recipientTransactionDELETE>();
...
void Urevenue_share_Recipient_recipientTransactionDELETE::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /recipient/transaction delete"));
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("delete"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionDELETE> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction delete: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /recipient/transaction delete: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_RecipientTransaction(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /recipient/transaction delete: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			{
				auto Result = DeserializeFHiverevenue_share_RecipientTransaction(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /recipient/transaction delete"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Recipient_recipientTransactionDELETE>(this));
  HttpRequest->ProcessRequest();
}
...
Urevenue_share_Stripe_stripePaymentEnabledPOST::Urevenue_share_Stripe_stripePaymentEnabledPOST(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Stripe_stripePaymentEnabledPOST* Urevenue_share_Stripe_stripePaymentEnabledPOST::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Stripe_stripePaymentEnabledPOST* Proxy = NewObject<Urevenue_share_Stripe_stripePaymentEnabledPOST>();
...
void Urevenue_share_Stripe_stripePaymentEnabledPOST::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /stripe/payment/enabled post"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/stripe/payment/enabled?paymentId=%s&enabled=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("post"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentEnabledPOST> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment/enabled post: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment/enabled post: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /stripe/payment/enabled post: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /stripe/payment/enabled post"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentEnabledPOST>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Stripe_stripePaymentStatusGET::Urevenue_share_Stripe_stripePaymentStatusGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Stripe_stripePaymentStatusGET* Urevenue_share_Stripe_stripePaymentStatusGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Stripe_stripePaymentStatusGET* Proxy = NewObject<Urevenue_share_Stripe_stripePaymentStatusGET>();
...
void Urevenue_share_Stripe_stripePaymentStatusGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /stripe/payment/status get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/stripe/payment/status?paymentId=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentStatusGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment/status get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment/status get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_InvoicePaymentStripeStatus(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /stripe/payment/status get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiverevenue_share_InvoicePaymentStripeStatus(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /stripe/payment/status get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentStatusGET>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Stripe_stripePaymentGET::Urevenue_share_Stripe_stripePaymentGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Stripe_stripePaymentGET* Urevenue_share_Stripe_stripePaymentGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Stripe_stripePaymentGET* Proxy = NewObject<Urevenue_share_Stripe_stripePaymentGET>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_paymentToken = paymentToken;

  return Proxy;
}

void Urevenue_share_Stripe_stripePaymentGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /stripe/payment get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/stripe/payment?paymentToken=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_paymentToken)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(FHiverevenue_share_PublicInvoicePayment(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /stripe/payment get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetObject(JsonObject))
			{
				auto Result = DeserializeFHiverevenue_share_PublicInvoicePayment(*JsonObject);
				UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /stripe/payment get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentGET>(this));
  HttpRequest->ProcessRequest();
}


Urevenue_share_Stripe_stripePaymentPUT::Urevenue_share_Stripe_stripePaymentPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Urevenue_share_Stripe_stripePaymentPUT* Urevenue_share_Stripe_stripePaymentPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Urevenue_share_Stripe_stripePaymentPUT* Proxy = NewObject<Urevenue_share_Stripe_stripePaymentPUT>();
  ...
  Proxy->Field_stripeToken = stripeToken;

  return Proxy;
}

void Urevenue_share_Stripe_stripePaymentPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] revenue-share /stripe/payment put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://revenue-share-api.hivemp.com/v1/stripe/payment?paymentToken=%s&stripeToken=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_paymentToken)

    , *FGenericPlatformHttp::UrlEncode(this->Field_stripeToken)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] revenue-share /stripe/payment put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] revenue-share /stripe/payment put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] revenue-share /stripe/payment put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Urevenue_share_Stripe_stripePaymentPUT>(this));
  HttpRequest->ProcessRequest();
}
...
struct FHivesearch_InternalSearchResult DeserializeFHivesearch_InternalSearchResult(const TSharedPtr<FJsonObject> obj)
{
  struct FHivesearch_InternalSearchResult Target;


  FString F_objectId;
  if (obj->TryGetStringField(TEXT("objectId"), F_objectId))
  {
    Target.objectId = F_objectId;
  }
...
Usearch_Cluster_internalSearchGET::Usearch_Cluster_internalSearchGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Cluster_internalSearchGET* Usearch_Cluster_internalSearchGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Cluster_internalSearchGET* Proxy = NewObject<Usearch_Cluster_internalSearchGET>();
  
  Proxy->WorldContextObject = WorldContextObject;
  Proxy->ApiKey = ApiKey;

  Proxy->Field_type = type;

  Proxy->Field_input = input;

  return Proxy;
}

void Usearch_Cluster_internalSearchGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /internal/search get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/internal/search?type=%s&input=%s")

    , *FGenericPlatformHttp::UrlEncode(this->Field_type)

    , *FGenericPlatformHttp::UrlEncode(this->Field_input)

  ));
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Cluster_internalSearchGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/search get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/search get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivesearch_InternalSearchResult>(), ResultError);
      return;
    }

    auto Response = HttpResponse.Get();

    UE_LOG_HIVE(Warning, TEXT("[info] search /internal/search get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				TArray<FHivesearch_InternalSearchResult> Result;
				for (int i = 0; i < JsonArray->Num(); i++)
				{
					const TSharedPtr<FJsonObject>* JsonArrayObj;
					if ((*JsonArray)[i]->TryGetObject(JsonArrayObj))
					{
						Result.Add(DeserializeFHivesearch_InternalSearchResult(*JsonArrayObj));
					}

				}
				UE_LOG_HIVE(Warning, TEXT("[success] search /internal/search get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Usearch_Cluster_internalSearchGET>(this));
  HttpRequest->ProcessRequest();
}


Usearch_Cluster_internalIndexPUT::Usearch_Cluster_internalIndexPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Cluster_internalIndexPUT* Usearch_Cluster_internalIndexPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Cluster_internalIndexPUT* Proxy = NewObject<Usearch_Cluster_internalIndexPUT>();
...
void Usearch_Cluster_internalIndexPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /internal/index put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/internal/index?type=%s&id=%s&title=%s&text=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Cluster_internalIndexPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/index put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/index put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] search /internal/index put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] search /internal/index put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Usearch_Cluster_internalIndexPUT>(this));
  HttpRequest->ProcessRequest();
}


Usearch_Cluster_internalIndexDELETE::Usearch_Cluster_internalIndexDELETE(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Cluster_internalIndexDELETE* Usearch_Cluster_internalIndexDELETE::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Cluster_internalIndexDELETE* Proxy = NewObject<Usearch_Cluster_internalIndexDELETE>();
...
void Usearch_Cluster_internalIndexDELETE::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /internal/index delete"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/internal/index?type=%s&id=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("delete"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Cluster_internalIndexDELETE> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/index delete: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /internal/index delete: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] search /internal/index delete: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] search /internal/index delete"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Usearch_Cluster_internalIndexDELETE>(this));
  HttpRequest->ProcessRequest();
}


Usearch_Search_searchGET::Usearch_Search_searchGET(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Search_searchGET* Usearch_Search_searchGET::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Search_searchGET* Proxy = NewObject<Usearch_Search_searchGET>();
...
void Usearch_Search_searchGET::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /search get"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/search?type=%s&input=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("get"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Search_searchGET> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /search get: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /search get: %s"), *(ResultError.Message));
      OnFailure.Broadcast(TArray<FHivesearch_InternalSearchResult>(), ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] search /search get: %s"), *(Response->GetContentAsString()));
...

    {
      struct FHiveApiError ResultError;
			...
			if (JsonValue->TryGetArray(JsonArray))
			{
				...
				UE_LOG_HIVE(Warning, TEXT("[success] search /search get"));
				OnSuccess.Broadcast(Result, ResultError);
			}
			else
			{
  ...
  }, TWeakObjectPtr<Usearch_Search_searchGET>(this));
  HttpRequest->ProcessRequest();
}


Usearch_Search_indexPUT::Usearch_Search_indexPUT(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Search_indexPUT* Usearch_Search_indexPUT::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Search_indexPUT* Proxy = NewObject<Usearch_Search_indexPUT>();
...
void Usearch_Search_indexPUT::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /index put"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/index?type=%s&id=%s&title=%s&text=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("put"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Search_indexPUT> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /index put: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /index put: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] search /index put: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] search /index put"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Usearch_Search_indexPUT>(this));
  HttpRequest->ProcessRequest();
}


Usearch_Search_indexDELETE::Usearch_Search_indexDELETE(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer), WorldContextObject(nullptr) { }

Usearch_Search_indexDELETE* Usearch_Search_indexDELETE::PerformHiveCall(
  UObject* WorldContextObject,
  FString ApiKey
...
{
  Usearch_Search_indexDELETE* Proxy = NewObject<Usearch_Search_indexDELETE>();
...
void Usearch_Search_indexDELETE::Activate()
{
  UE_LOG_HIVE(Display, TEXT("[start] search /index delete"));


  TSharedRef<IHttpRequest> HttpRequest = FHttpModule::Get().CreateRequest();
  HttpRequest->SetURL(FString::Printf(
    TEXT("https://search-api.hivemp.com/v1/index?type=%s&id=%s")
  ...
  HttpRequest->SetHeader(TEXT("api_key"), this->ApiKey);
  HttpRequest->SetVerb(TEXT("delete"));
  HttpRequest->OnProcessRequestComplete().BindLambda([this](FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, TWeakObjectPtr<Usearch_Search_indexDELETE> SelfRef)
  {
    if (!SelfRef.IsValid())
    {
      UE_LOG_HIVE(Error, TEXT("[fail] search /index delete: Callback proxy is invalid (did the game shutdown?)"));
      return;
    }
    ...
    if (!HttpResponse.IsValid())
    {
      ...
      ResultError.Message = TEXT("HTTP response was not valid!");
      ResultError.Parameter = TEXT("");
      UE_LOG_HIVE(Error, TEXT("[fail] search /index delete: %s"), *(ResultError.Message));
      OnFailure.Broadcast(0, ResultError);
      return;
    }
    ...
    UE_LOG_HIVE(Warning, TEXT("[info] search /index delete: %s"), *(Response->GetContentAsString()));


    if (Response->GetContentAsString().Equals(TEXT("true")))
    {
      struct FHiveApiError ResultError;
      UE_LOG_HIVE(Warning, TEXT("[success] search /index delete"));
      OnSuccess.Broadcast(true, ResultError);
      return;
    }
    else if (Response->GetContentAsString().Equals(TEXT("false")))
  ...
  }, TWeakObjectPtr<Usearch_Search_indexDELETE>(this));
  HttpRequest->ProcessRequest();
}
